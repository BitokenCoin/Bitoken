...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xc0dd0;
...
const char     CRYPTONOTE_NAME[]                             = "Bitoken";
...
const int      P2P_DEFAULT_PORT                              = 28100;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 28500;
...
const std::initializer_list<const char*> SEED_NODES = {
  //"your_seed_ip1.com:28100",
  //"your_seed_ip2.com:28100",
};
